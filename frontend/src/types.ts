...
export interface AnalysisState {
  ...
  /**
   * True when the most recent results were served from the orchestrator's
   * DynamoDB cache (set by the `cached: true` flag on the API response).
   * Drives the "Cached" badge on the Results header.
   */
  cached: boolean;
  /** ISO timestamp of when the cached entry was originally written. */
